...
def _keyauth_debug_dir(exe_name):
    """User-writable log path (ProgramData needs admin and often fails)."""
    base = (
    ...
    return os.path.join(base, "KeyAuth", "Debug", exe_name)


def _keyauth_write_debug_log(exe_name, post_data, response, client_computed, signature):
    try:
        debug_dir = _keyauth_debug_dir(exe_name)
...
class api:
    ...
    def __do_request(self, post_data):
        try:
            ...
            _keyauth_write_debug_log(
                exe_name, post_data, response, client_computed, signature
            )
